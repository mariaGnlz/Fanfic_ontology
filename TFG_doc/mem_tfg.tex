...
Proyecto que usa NLTK para extraer relaciones de tipo DateOfBirth y HasParents de Rojit Jose \cite{jose_2017} \todo[size=\tiny]{mirar intro del libro de eisenstein}
\href{https://nlp.stanford.edu}{Stanford Natural Language Processing Group}
Kernel para extracción de relaciones \cite{zelenko_2003} \todo[size=\tiny]{explicar bag of words + función que calcula peso en función de vector características}
...
\begin{figure}[!h]
	...
	\begin{subfigure}{.4\textwidth}
		...
		\caption{Diagrama de clustering.}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[scale=0.3]{ejecucion_kmeans_tokv2_0}
		\caption{Ejecución del programa de clustering mostrando su evaluación.}
	\end{subfigure}
...
LDA es un algoritmo que descubre temas de forma no supervisada. Trabaja bajo la asunción de que cada documento es un conjunto de temas, y que cada tema es un conjunto de palabras.
