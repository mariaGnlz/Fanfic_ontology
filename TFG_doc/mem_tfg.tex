...
Una vez completado el proceso del RFE dataset, utilicé la información almacenada en los archivos \textit{fic\_characters.csv} y \textit{fic\_sentences.csv} (tabla \ref{table:fic_sentences})para realizar varias técnicas de análisis de texto natural, con la esperanza de hallar algún patrón, bigrama o palabra significativa que me ayudara a identificar relaciones entre personajes.
...
\todo{programa principal}
\missingfigure{NERTagger + CoreProcessor = personajes}


\section{EVALUACIÓN DEL SISTEMA}

\todo{1- fanfic corto 'normal', mostrar personajes acertados y errados 2-fanfic con personaje con genero distinto del canon 3- fanfic con personaje genderfluid}
