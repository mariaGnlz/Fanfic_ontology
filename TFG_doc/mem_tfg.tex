...
En AO3, cada fanfic tiene un número que lo identifica de forma única. Es posible acceder a la página de cualquier fanfic simplemente añadiendo ese número al final de 'http://www.archiveofourown.org/works/' en la barra de direcciones, y en esa página sí que se pueden encontrar links de descarga.
...
Por tanto la idea básica para el \textit{scraper} es explorar los veinte \textit{'work blurb group'} de cada página, extraer el identificador de cada fanfic, utilizarlo para acceder a la página del mismo y extraer el link de descarga. Y así con cada página del listado, hasta llegar a la última. La \ref{fig:ao3_structure} ilustra el proceso con un esquema. 
